...
* @param {string?} symbol - symbol for the currency to be used, e.g. 'NEP'. If defined, the symbol will be displayed, e.g. 123.00 NEP.
...
/**
 * Converts gas price, which is in its own unit, to NEP
 *
 * @param {string} gasUsed - amount of gas used as string representation of a number/hex
 * @param {string} gasPrice - gas price in NEP as string representation of a number/hex
 *
 * @return {string} gas in NEP as a number string
 */
