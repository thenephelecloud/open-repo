...
* @param {number?} tokenDecimals - required if amount is BigNumber. The number of decimals a token has, e.g. 18 for NEP. This option is not used for non-BigNumber amounts
