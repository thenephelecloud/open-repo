            ...
            () => {
                this.stlosContractInstance.previewDeposit(this.topInputAmount)
                    ...
                    .catch((err: any) => {
                        ...
                        console.error(`Unable to convert NEP to STLOS: ${err}`);
                        this.$q.notify({
                            type: 'negative',
        ...
        this.debouncedBottomInputHandler = debounce(
            () => {
                this.stlosContractInstance.previewRedeem(this.bottomInputAmount)
                    ...
                    .catch((err: any) => {
                        this.topInputAmount = '';
                        console.error(`Unable to convert STLOS to NEP: ${err}`);
                        this.$q.notify({
                            type: 'negative',
                            message: this.$t('pages.staking.redeem_failed', { message: err }),
                        });
        ...
        async initiateDeposit() {
            ...
            try {
                ...
                this.continueDeposit(value).then((result) => {
                    ...
                    console.error(`Failed to deposit NEP: ${message}`);
                ...
                console.error('Failed to deposit NEP', e);
                this.ctaIsLoading = false;
            }
        },
