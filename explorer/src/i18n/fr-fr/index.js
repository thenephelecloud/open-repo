...
export default {
    ...
    pages: {
        staking: {
            ...
            claim_tlos: 'Réclamer votre NEP',
            add_stlos_to_metamask: 'Ouvrez le dialogue MetaMask pour ajouter sTLOS',
            metamask_fox_logo: 'MetaMask logo renard',
            cancel: 'Annuler',
            stake_tlos_confirm: 'En continuant vous miserez vos NEP en échange de sTLOS. ' +
                'Les sTLOS peuvent être converti en NEP à tout moment à l\'aide de l\'onglet Unstake.',
            stake_tlos_confirm_2a: 'Après que les NEP sont unstake, ils seront vérouillés pour une période de', /* unstakePeriodPretty...*/
            ...
            stake_tlos: 'Staker vos NEP',
            stake_tlos_subheader: 'Staker vos NEP contre des sTLOS vous permet d\'accèder à un revenu passif ainsi qu\'à diverses applications DeFi, ' +
                'vous permettant d\'augmenter encore plus le rendement. Le taux de conversion de NEP à sTLOS change au fur et à mesure que le bassin de récompense se rempli,  ' +
            ...
            insufficient_tlos_balance: 'Solde de NEP non suffisant pour stake',
            ...
            click_to_input_full_wallet_balance: 'Cliquez pour choisir le solde entier de votre portefeuille\n\n' +
                'Le solde montré est réduit de 1 NEP afin de pouvoir régler les frais de gaz.\n' +
                'Solde exact (moins les frais de gaz approximatifs):\n' +
                '{prettyBalance} NEP',
            loading: 'Chargement...',
            get_more_tlos: 'Obtenez plus de NEP',
            ...
            stake_tlos_earn_interest: 'Stakez votre NEP contre des sTLOS pour gagner des interêts à partir du bassin de récompense',
            staked: 'Staké',
            unstaked: 'Unstaké',
            tooltip_1: 'APY: Pourcentage annuel de rendement\n\n Ce pourcentage répresente les interêts gagnés sur un an et prend.\n\n' +
                ...
                'ce qui veut dire qu\'il changera au fur et à mesure du temps suivant le total de NEP stake à la fois sur l\'EVM et la chaîne native. ' +
                'Les récompenses sont distribués à partir d\'un bassin de récompense communautaire directement dans le contract sTLOS.',
            tooltip_2: 'TVL: Valeur Totale Vérouillé\n\nLa valeur actuelle, en NEP, de tout les actifs déposés dans le contrat sTLOS ' +
                '(Staked NEP), c\'est à dire la somme de tout les NEP stakés sur l\'EVM Telos à l\'instant T.',
            tooltip_3: 'Staké\n\n' +
                'Le montant total staké par le compte connecté, c\'est à dire ' +
                ' votre solde de jetons sTLOS, ainsi que sa valeur en NEP',
            tooltip_4: 'Unstaké\n\n' +
                'La valeur total de NEP que vous avez unstaké, vérouillé ou non.\n\n' +
                'Quand vous unstakez\u2014c\'est à dire récuperez\u2014 un montant de sTLOS, le montant équivalent de ' +
                'NEP est envoyé dans un contract de dépot fiduciare où il est verrouillé pour {unlockPeriod}; pendant cette période, ' +
                'vous ne pourrez pas intéragir avec voc NEP.\n\n' +
                'Une fois la période de vérouillage finie, vous pourrez éffectuer un retrait de vos NEP dévérouillés ' +
                ' à partir de l\'onglet Retrait sur cette page, il sera alors ajouté au solde NEP de votre compte.',
            confirm_unstake_1a: 'Continuer va échanger vos sTLOS contre des NEP. ' +
                'Les NEP unstaké vont rester vérouillé pour une période de', /* unstakePeriodPretty...*/
            ...
            confirm_unstake_2b: /*...remainingDeposits */ 'fois avant ' +
                ...
                'retirer vos NEP pour continuer à unstaker. Si vous n\'avez pas encore de NEP retirable il vous faudra' +
                'attendre jusqu\'a que la durée de verrouillage soit écoulée avant de pouvoir les retirer et de unstake plus de sTLOS. -',
            unstake_stlos_for_tlos: 'Unstaker vos sTLOS contre des NEP',
            unstake_stlos: 'Unstaker vos sTLOS',
            receive_tlos: 'Recevez NEP',
            amount: 'Montant',
            ...
            fetch_unstaked_balance_error: 'Échec de récupération du total de NEP unstaked: { message }',
            ...
            fetch_conversion_rate_error: 'Échec de récupération du taux de conversion NEP->sTLOS: { message }',
            ...
            convert_tlos_to_stlos_error: 'Impossible de convertir NEP en sTLOS: { message }',
            convert_stlos_to_tlos_error: 'Impossible de convertir sTLOS en NEP: { message }',
            unstake_stlos_error: 'Échec lors de l\'unstake de sTLOS { message }',
            withdraw_failed: 'Échec du retrait des NEP déverrouillés: { message }',
        },
    ...
    components: {
        ...
        contract_tab: {
            ...
            read_as_proxy: 'Lire en tant que proxy',
            write_as_proxy: 'Écrire en tant que proxy',
            contract_is_proxy: 'Ce contrat est un proxy transparent EIP-1967 pour le contrat',
            proxy_for_unverified_contract_part_1: 'Le contrat pour lequel il s\'agit d\'un proxy n\'est pas vérifié, son ABI n\'est donc pas disponible. Pour interagir avec le contrat de mise en œuvre, visitez le',
            proxy_for_unverified_contract_part_2: 'page du contrat de mise en œuvre',
            no_abi_methods: 'Aucune fonction exécutable trouvée dans le contrat ABI',
        },
        header: {
            sign_in: 'Connexion',
