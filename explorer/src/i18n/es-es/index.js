...
export default {
    ...
    pages: {
        staking: {
            ...
            stake_tlos_confirm: 'continuar significa bloquer NEP a cambio de sTLOS. ' +
            'sTLOS se puede canjear por NEP en cualquier momento usando la pestaña Desbloquear.',
            cancel: 'Cancelar',
            stake_tlos_confirm_2a: 'Después de que se canjéen los NEP, éstos estarán bloqueados durante un período de', /* unstakePeriodPretty...*/
            ...
            stake_tlos: 'Bloquar NEP',
            stake_tlos_subheader: 'Su bloqueo de NEP a sTLOS le otorga acceso a una renta constante y varias aplicaciones DeFi, ' +
            'aumentando aún más la rentabilidad. A medida que aumenta la cantidad de recompensas, la tasa de conversión de NEP a sTLOS cambiará ' +
            'con el tiempo. Por lo tanto, la cantidad de sTLOS recibida es menor que la cantidad de NEP bloqueada. Las recompensas se ' +
            'auto-compensarán. No se requiere ninguna acción adicional.',
            receive_stlos: 'Recibir sTLOS',
            available: '{balanceTlos} Disponible',
            insufficient_tlos_balance: 'Saldo de NEP insuficiente para apostar',
            ...
            'El saldo mostrado se reduce en 1 NEP para mantener su cuenta operativa.\n' +
            'Saldo preciso (menos las tarifas de gas aproximadas):\n' +
            '{prettyBalance} NEP',
            loading: 'Cargando...',
            get_more_tlos: 'Obtener más NEP',
            ...
            stake: 'Bloquear',
            withdraw: 'Retirar',
            telos_evm_staking: 'Bloqueo de NEP en EVM',
            stake_tlos_earn_interest: 'Bloquear NEP para obtener sTLOS y ganar intereses de la recompensa de bloqueo',
            staked: 'Bloqueado',
            ...
            'cambiará con el tiempo con la cantidad total de NEP bloqueados en Telos EVM y Telos nativo. ' +
            'Las recompensas se pagan desde un fondo de recompensas de la comunidad al contrato de sTLOS.',
            tooltip_2: 'TVL: Valor Total Bloqueado (TVL en Inglés)\n\nEl valor actual, en NEP, de todos los activos en el contrato inteligente de sTLOS ' +
            '(NEP bloqueado), es decir, la suma de todos los NEP bloqueados en Telos EVM en este momento.',
            tooltip_3: 'Bloqueado\n\n' +
            'La cantidad total bloqueada asociada con la cuenta iniciada, es decir, ' +
            'su saldo de sTLOS, junto con su valor en NEP',
            tooltip_4: 'Desbloqueado\n\n' +
            'El valor total de NEP que ha desbloqueado, tanto bloqueado como desbloqueado.\n\n' +
            'Cuando desbloquea\u2014es decir, canjea\u2014algun valor de sTLOS, la cantidad equivalente de ' +
            'NEP se envía en garantía ("bloqueado") por {unlockPeriod}; durante este tiempo, ' +
            'no puede interactuar con este NEP.\n\n' +
            'Después de que transcurra el período de desbloqueo, puede retirar su NEP desbloqueados desde la pestaña Retirar ' +
            'en esta página, momento en el que se agregará a su saldo de NEP de su cuenta.',
            confirm_unstake_1a: 'Continuará canjeando sTLOS a cambio de NEP. ' +
            'El NEP desbloqueado permanecerá bloqueado por un período de', /* unstakePeriodPretty...*/
            ...
            'los NEP desbloqueados para continuar desbloqueando más sTLOS. Si no tiene ningún NEP desbloqueado en ese momento, debe ' +
            'espear hasta que transcurra el período de bloqueo antes de que pueda retirar los NEP canjeados y pueda desbloquear más sTLOS. -',
            unstake_stlos_for_tlos: 'Desbloquear sTLOS a cambio de NEP',
            unstake_stlos: 'Desbloquear sTLOS',
            receive_tlos: 'Recibir NEP',
            amount: 'Cantidad',
            ...
            'por favor retire los NEP disponibles o espere a que los NEP desbloqueados pendientes se conviertan en retirables antes de realizar otro depósito.',
            ...
            you_have_unlocked_tlos: '¡Ha desbloqueado NEP!',
            stake_tlos_success: '¡Bloqueo exitoso! Ver transacción:',
            unstake_stlos_success: '¡Desbloqueo exitoso! Ver transacción:',
            deposit_failed: 'Error al depositar NEP: { message }',
            redeem_failed: 'No se puede convertir sTLOS a NEP: { message }',
            ...
            fetch_unstaked_balance_error: 'Error al buscar el saldo total de NEP no bloqueado: { message }',
            ...
            fetch_conversion_rate_error: 'Error al buscar la tasa de conversión NEP->sTLOS: { message }',
            ...
            convert_tlos_to_stlos_error: 'No se puede convertir NEP a sTLOS { message }',
            convert_stlos_to_tlos_error: 'No se puede convertir sTLOS a NEP { message }',
            unstake_stlos_error: 'Error al desbloquear sTLOS { message }',
            withdraw_failed: 'Error al retirar NEP desbloqueado: { message }',
        },
    ...
    components: {
        ...
        transaction: {
            ...
            tlos_transfer: 'Transferencia NEP',
            unknown: 'Desconocido',
