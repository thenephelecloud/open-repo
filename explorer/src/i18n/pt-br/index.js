...
export default {
    ...
    pages: {
        staking: {
            ...
            cancel: 'Cancelar',
            stake_tlos_confirm: 'Continuar significa aplicar NEP em troca de sTLOS. ' +
            'sTLOS podem ser resgatados por NEP a qualquer momento usando a aba Desaplicar.',
            stake_tlos_confirm_2a: 'Depois que desaplicar os NEP, eles ficarão bloqueados por um período de', /* unstakePeriodPretty...*/
            ...
            stake_tlos: 'Aplicar NEP',
            stake_tlos_subheader: 'Aplicar seus NEP por sTLOS te dá acesso a uma renda estável e várias aplicações DeFi, ' +
            'aumentando ainda mais a rentabilidade. Conforme o tamanho da pool de recompensas aumenta, a taxa de conversão de NEP para sTLOS mudará ' +
            'com o tempo. Portanto, a quantidade de sTLOS recebida é menor que a quantidade de NEP aplicada. As recompensas se ' +
            'auto-compensarão. Não é necessária nenhuma ação adicional.',
            receive_stlos: 'Receber sTLOS',
            available: '{balanceTlos} Disponível',
            insufficient_tlos_balance: 'Saldo de NEP insuficiente para aplicar',
            ...
            'O saldo mostrado é reduzido em 1 NEP para manter sua conta operacional.\n' +
            'Saldo exato (menos as tarifas de gás aproximadas):\n' +
            '{prettyBalance} NEP',
            loading: 'Carregando...',
            get_more_tlos: 'Obter mais NEP',
            ...
            stake: 'Aplicar',
            withdraw: 'Retirar',
            telos_evm_staking: 'Aplicação de NEP em EVM',
            stake_tlos_earn_interest: 'Aplicar NEP em sTLOS para ganhar juros do pool de recompensas por aplicação',
            staked: 'Aplicado',
            ...
            'mudará ao longo do tempo com a quantidade total de NEP aplicados em Telos EVM e Telos Native. ' +
            'As recompensas são pagas de um pool de recompensas da comunidade para o contrato sTLOS.',
            tooltip_2: 'VTB: Valor Total Bloqueado (TVL em inglês)\n\nO valor atual, em NEP, de todos os ativos mantidos no sTLOS ' +
            '(Staked NEP, que significa NEP aplicados em inglês), ou seja, a soma de todos os NEP aplicados no Telos EVM neste momento.',
            tooltip_3: 'Aplicado\n\n' +
            'O montante total aplicado associado com a conta logada, ou seja, ' +
            'seu saldo de tokens sTLOS, junto com seu valor em NEP',
            tooltip_4: 'Desaplicado\n\n' +
            'O valor total de NEP desaplicados que você tem, tanto bloqueados quanto desbloqueados.\n\n' +
            'Quando você desaplica\u2014ou seja, resgata\u2014parte do valor em sTLOS, a quantidade equivalente de ' +
            'NEP permanece como garantia ("bloqueado") por {unlockPeriod}; durante este tempo, ' +
            'não é possível interagir com esta quantidade de NEP.\n\n' +
            'Depois de decorrido o período de desbloqueio, você pode reivindicar seu NEP disponível na aba Resgatar ' +
            'nesta página. O valor resgatado será adicionado ao saldo NEP da sua conta.',
            confirm_unstake_1a: 'Ao continuar, você resgatará sTLOS em troca de NEP. ' +
            'O NEP não aplicado permanecerá bloqueado por um período de', /* unstakePeriodPretty...*/
            ...
            'NEP desbloqueado para continuar desaplicando. Se você não tiver nenhum NEP resgatável nesse momento, você deve ' +
            'aguardar até que a duração do bloqueio acabe, antes de resgatar o NEP desbloqueado e desaplicar mais sTLOS. -',
            unstake_stlos_for_tlos: 'Desaplicar sTLOS em troca de NEP',
            unstake_stlos: 'Desaplicar sTLOS',
            receive_tlos: 'Receber NEP',
            amount: 'Montante',
            ...
            'por favor, resgate o NEP disponível ou aguarde que o NEP  desaplicado ainda pendente se torne resgatável antes de fazer outro depósito.',
            ...
            you_have_unlocked_tlos: 'Você desbloqueou NEP!',
            stake_tlos_success: 'Aplicação bem-sucedida! Ver transação:',
            unstake_stlos_success: 'Desaplicação bem-sucedida! Ver transação:',
            deposit_failed: 'Falha ao depositar NEP: { message }',
            redeem_failed: 'Não foi possível converter STLOS em NEP: { message }',
            ...
            fetch_unstaked_balance_error: 'Falha ao buscar saldo total de NEP não aplicado: { message }',
            ...
            fetch_conversion_rate_error: 'Falha ao buscar taxa de conversão NEP->sTLOS: { message }',
            ...
            convert_tlos_to_stlos_error: 'Não foi possível converter NEP em STLOS { message }',
            convert_stlos_to_tlos_error: 'Não foi possível converter STLOS em NEP { message }',
            unstake_stlos_error: 'Falha ao desaplicar sTLOS { message }',
            withdraw_failed: 'Falha ao retirar NEP desbloqueado: { message }',
        },
    ...
    components: {
        ...
        transaction: {
            ...
            tlos_transfer: 'Transferência NEP',
        ...
        contract_tab: {
            ...
            read_as_proxy: 'Ler como Proxy',
            write_as_proxy: 'Escrever como Proxy',
            contract_is_proxy: 'Este contrato é um Proxy Transparente EIP-1967 para o contrato',
            proxy_for_unverified_contract_part_1: 'O contrato para o qual este é um proxy não está verificado, então sua ABI não está disponível. Para interagir com o contrato de implementação, visite a',
            proxy_for_unverified_contract_part_2: 'página do contrato de implementação',
            no_abi_methods: 'Nenhuma função executável encontrada na ABI do contrato',
        },
        header: {
            sign_in: 'Entrar',
            sign_out: 'Sair',
