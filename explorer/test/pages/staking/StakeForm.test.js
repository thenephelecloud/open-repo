...
describe('StakeForm.vue', () => {
    ...
    it('should render a banner when the user has unlocked NEP', async () => {
        const wrapper = shallowMount(StakeForm, {
            props:  { ...defaultProps },
            global: { ...globalMock()   },
        });
    ...
    it.skip('should render properly when the user has successfully staked NEP', async () => {
        jest.useFakeTimers();
